...
if(isset($_POST['order'])){
   ...
   $address = 'house no. '. $_POST['house'] .', '. $_POST['street'] .', '. $_POST['city'] .', '. $_POST['country'] .' ';
   ...
   <h3>your orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="house" placeholder="e.g. house number" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>city/town:</span>
            <input type="text" name="city" placeholder="e.g. Accra" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>country/state :</span>
            <input type="text" name="country" placeholder="e.g. Ghana" class="box" maxlength="50" required>
         </div>
      </div>
